...
let
  sources = {
    ...
    "rescript-10.1.0-rc.5" = {
      ...
      version = "10.1.0-rc.5";
      src = fetchurl {
        url = "https://registry.npmjs.org/rescript/-/rescript-10.1.0-rc.5.tgz";
        sha512 = "57/4oETx9s0uiCof1Yfo/SU3kyDE/AHf2RjMpIpdXeYhaa62C0f15cbLCAHehJEy/L6kJUHoQBzNqQ0OuumcSQ==";
      };
    };
